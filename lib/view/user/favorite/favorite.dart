                                ...
                                data['offer']
                                    ? TextSpan(
                                        children: <TextSpan>[
                                          ...
                                          new TextSpan(
                                            text:
                                                " ${(data["price"]).toString()} ${AppLocale.of(context).getTranslated("delivery_cost_unit")}",
                                            style: new TextStyle(
                                              color: CustomColors.primary,
                                            ),
                                          ),
      ...
      onTap: () async {
        favoriteMethodAPI.removeFavorite(data["id"]).then((value) {
          ...
          final snackBar = SnackBar(
              ...
              content: Text(
                AppLocale.of(context).getTranslated("lang") == 'English'
                    ? "مرحباُ : تم ازالة المنتج من المفضلة ب نجاح.."
                    : "Hello: The product has been removed from Favorite with success ..",
                style: TextStyle(color: CustomColors.greenLightFont),
              ));
          _favoriteScaffoldKey.currentState.showSnackBar(snackBar);
        });
      },
      child: Padding(
